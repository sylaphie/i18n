...
const language: Language = {
	...
	phrases: {
		...
		Loved: 'Любимый',
		Artist: 'Исполнитель',
		'Featured Artist': 'Приглашенный исполнитель',
		Graveyard: 'Заброшенный',
		graveyard: 'заброшенный',
		Plays: 'Игры',
		Status: 'Статус',
		'Explicit Content': 'Явный контент',
		...
		'Circle Count': 'Количество кругов',
		'Slider Count': 'Количество слайдеров',
		'Spinner Count': 'Количество спиннеров',
		'Max Combo': 'Макс. комбо',
		'Play Count': 'Количество игр',
		...
		'Approach Rate': 'Скорость приближения',
		'HP Drain': 'Слив HP',
		by: 'от',
		'Beatmap Preview': 'Предварительный просмотр битмапы',
